...
const config = {
  title: 'Routing Docs',
  tagline: 'Guida approfondita sul routing',
  favicon: 'img/router.ico',
  ...
  organizationName: 'Vitaliy Didyk', // Usually your GitHub org/user name.
  projectName: 'Routing Docs', // Usually your repo name.
